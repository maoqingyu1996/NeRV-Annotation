...
class Generator(nn.Module):
    def __init__(self, **kargs):
        ...
        # [112]
        ngf = self.fc_dim
        # [5,2,2,2,2] for 720p, [5,3,2,2,2] for 1080P
        for i, stride in enumerate(kargs['stride_list']):
            # expansion = 1,不扩张，如果扩张输出层MLP参数量会非常大
            if i == 0:
